...
export class JobArtifactService
{
    ...
    ): Promise<string>
    {
        ...
        this.database?.upsertLibraryItem({
            ...
            bookId: translatedBook.bookId,
            canonicalBookKey: translatedBook.canonicalBookKey,
            coverUrl: translatedBook.coverUrl,
            description: translatedBook.description,
            hasOriginal: true,
            hasTranslated: true,
            language: translatedBook.language,
            originalPath: originalTxt,
            relativeDir: dirname(targetTxt),
            sourceBookId: translatedBook.sourceBookId ?? translatedBook.bookId,
            sourceId: translatedBook.sourceId ?? "fanqie",
